Você deve criar um programa para avaliar se um aluno foi aprovado na disciplina de ATP. O programa deve determinar se o aluno foi aprovado, está em recuperação ou reprovado.
...
Seu programa deve ler as 5 notas e a frequência e imprimir o valor de pontos obtidos em cada módulo, assim como o status do aluno na disciplina.

Atenção: Seu programa deve validar corretamente se o aluno poderá ou não fazer a reavaliação, levando em consideração os pontos obtidos nos módulos e a nota das atividades.
